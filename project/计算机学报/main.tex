...
\classsetup{
  % 配置里面不要出现空行
  title        = {人工智能大作业实验报告},
  title*       = {AI Security Project Report},
  authors      = {
    author1 = {
      name         = {黄宇成},
      name*        = {Huang Yucheng},
  ...
  affiliations = {
    aff1 = {
      name  = {浙江大学 \ 计算机科学技术学院, 杭州市 中国\ },
      name* = {Department of Computer Science, Zhejiang University, City Hangzhou, China},
    },
    aff2 = {
      name  = {浙江大学 \ 计算机科学技术学院, 杭州市 中国\ },
      name* = {Department of Computer Science, Zhejiang University, Hangzhou, China},
    },
  },
  abstract     = {
